...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'write_price_rules,read_price_rules,write_discounts,read_discounts ,read_themes,write_themes,read_products,write_products,write_script_tags ,read_orders,write_orders'),
